<template>
	<div>
		<div class="mb-4 flex items-center justify-between">
			...
			<Link href="/admin/roles" class="text-sm text-gray-700 hover:text-gray-900">Back to Roles</Link>
		</div>
		...
		<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
			<form @submit.prevent="submit" class="space-y-4">
				...
				<div class="flex items-center gap-3">
					...
					<Link href="/admin/roles" class="text-sm text-gray-700 hover:text-gray-900">Cancel</Link>
				</div>
			</form>
		</div>
	</div>
